    ...
    try {
        ...
        for (const oldUser of oldUsers) {
            ...
            const newUser = {
                ...
                lookingFor: removeHtmlTags(oldUser.Looking && oldUser.Looking.includes(",") ? "All" : oldUser.Looking || ""),
                ...
                preferredWorkingCities: removeHtmlTags(oldUser.preferredWorkingCities || ""),
                preferredNativeCities: removeHtmlTags(oldUser.preferredNativeCities || ""),
